...
@online{debianhistory,
    ...
    urldate = {2023-11-22},
    note = {[Accessed November 22, 2023]}
}
\end{filecontents}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            xmin=1994, xmax=2024,
            ymin=0, ymax=70000,
            xtick={1995, 2000, 2005, 2010, 2015, 2020, 2023},
        ...
        % Data points: Year vs Approx Package Count
        ...
        coordinates {
            ...
            (2013, 37000) % 7.0 Wheezy
            (2015, 43000) % 8.0 Jessie
            (2017, 51000) % 9.0 Stretch
            (2019, 59000) % 10 Buster
            (2021, 59551) % 11 Bullseye
        ...
        \node[anchor=south east] at (axis cs: 2013, 37000) {\tiny Wheezy};
